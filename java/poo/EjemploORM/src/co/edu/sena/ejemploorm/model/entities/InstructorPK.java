...
public class InstructorPK implements Serializable {
    ...
    public InstructorPK(String personanumeroDocumento, String personaDocumentoidDocumento) {
    ...
    public String toString() {
        return "co.edu.sena.ejemploorm.model.entities.InstructorPK[ personanumeroDocumento=" + personanumeroDocumento + ", personaDocumentoidDocumento=" + personaDocumentoidDocumento + " ]";
    }
